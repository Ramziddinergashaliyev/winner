...
const cardsRu = [
    {
        number: '01',
        image: img1,
        title: ['Создано Для', 'Победы'],
        text: 'WINNER — это высокотехнологичное моторное масло, разработанное для экстремальных условий и максимальной производительности.',
        link: 'Узнать больше',
    },
    {
        number: '02',
        image: img2,
        title: ['Технологии,', 'Ведущие Вперёд'],
        text: 'Передовые формулы и строгий контроль качества обеспечивают защиту двигателя, мощность и надёжность на каждом километре.',
        link: 'Наши Технологии',
    },
    {
        number: '03',
        image: img3,
        title: ['Доверие', 'Чемпионов'],
        text: 'WINNER выбирают профессиональные гонщики и команды по всему миру. Победители выбирают лучшее.',
        link: 'Наши Партнёры',
    },
]
...
const cardsUz = [
    {
        number: '01',
        image: img1,
        title: ['G\'alaba Uchun', 'Yaratilgan'],
        text: 'WINNER — ekstremal sharoitlar va maksimal ishlash uchun ishlab chiqilgan yuqori texnologiyali motor moyi.',
        link: 'Batafsil',
    },
    {
        number: '02',
        image: img2,
        title: ['Yetakchi', 'Texnologiya'],
        text: 'Ilg\'or formulalar va qat\'iy sifat nazorati dvigatel himoyasi, quvvat va ishonchlilikni ta\'minlaydi — har bir kilometrda.',
        link: 'Bizning Texnologiyamiz',
    },
    {
        number: '03',
        image: img3,
        title: ['Chempionlar', 'Ishonchi'],
        text: 'WINNER — butun dunyo bo\'ylab professional poyga ishtirokchilari va jamoalar tanlovi. G\'oliblar eng yaxshisini tanlaydi.',
        link: 'Bizning Hamkorlarimiz',
    },
]
...
const Info = () => {
    ...
    const cards =
        currentLang === 'ru' ? cardsRu :
            currentLang === 'uz' ? cardsUz :
                cardsEn
